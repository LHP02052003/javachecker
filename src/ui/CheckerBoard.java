...
public class CheckerBoard extends JButton {
	...
	public CheckerBoard(CheckersWindow window, Game game,
		...
		this.lightTile = new Color(242, 202, 43);
		this.darkTile = new Color(77, 29, 2);
		this.window = window;
		setPlayer1(player1);
		setPlayer2(player2);
	}
	...
	public void setLightTile(Color lightTile) {
		this.lightTile = (lightTile == null)? new Color(242, 202, 43) : lightTile;
	}
	...
	public void setDarkTile(Color darkTile) {
		this.darkTile = (darkTile == null)? new Color(77, 29, 2) : darkTile;
	}
